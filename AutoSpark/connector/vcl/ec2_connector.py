...
def main(argv):
    ...
    cmd_format = "vcl-opsworks request add --image-id 3685 -n slave -c {0} -l {1} --playbook main1.yml \"https://vcl.ncsu.edu/scheduling/index.php?mode=xmlrpccall\" \""+user+"@NCSU\""
